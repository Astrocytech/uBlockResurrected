    ...
    async insertCSS(tabId, details) {
        if ( typeof browser.scripting !== 'undefined' ) {
            ...
            try {
                ...
                // console.error('[DEBUG vapi-background] scripting.insertCSS error:', e);
            }
        }
        if ( vAPI.supportsUserStylesheets ) {
    ...
    async removeCSS(tabId, details) {
        if ( typeof browser.scripting !== 'undefined' ) {
            ...
            try {
                ...
                // console.error('[DEBUG vapi-background] scripting.removeCSS error:', e);
            }
        }
        if ( vAPI.supportsUserStylesheets ) {
            details.cssOrigin = 'user';
...
if ( browserActionOnClicked instanceof Object ) {
    browserActionOnClicked.addListener(function(tab) {
        vAPI.tabs.open({
            select: true,
