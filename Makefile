...
.PHONY: all clean cleanassets test lint chromium opera firefox npm dig \
	...
	upload-firefox upload-dev-firefox chromium-mv3
...
dist/build/uBlock0.firefox-mv3: tools/make-firefox-mv3.sh $(sources) $(platform) $(assets)
	tools/make-firefox-mv3.sh all

# Build the extension for Firefox MV3.
firefox-mv3: dist/build/uBlock0.firefox-mv3

dist/build/uBlock0.chromium-mv3: tools/make-chrome-mv3.sh $(sources) $(platform) $(assets)
	tools/make-chrome-mv3.sh all

# Build the extension for Chromium MV3.
chromium-mv3: dist/build/uBlock0.chromium-mv3
