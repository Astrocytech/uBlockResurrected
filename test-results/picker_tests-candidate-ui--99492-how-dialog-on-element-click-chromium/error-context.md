...
- Name: picker_tests/candidate-ui.spec.ts >> Picker Candidate UI >> Dialog Display >> should show dialog on element click
- Location: tests/picker_tests/candidate-ui.spec.ts:42:9
