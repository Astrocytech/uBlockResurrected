...
- Name: picker_tests/candidate-ui.spec.ts >> Picker Candidate UI >> Candidate Parts Toggle >> should show full attribute when toggled on
- Location: tests/picker_tests/candidate-ui.spec.ts:197:9
