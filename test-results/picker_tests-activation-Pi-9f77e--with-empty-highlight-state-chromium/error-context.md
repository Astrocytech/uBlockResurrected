...
- Name: picker_tests/activation.spec.ts >> Picker Activation >> Picker State >> should initialize with empty highlight state
- Location: tests/picker_tests/activation.spec.ts:135:9
