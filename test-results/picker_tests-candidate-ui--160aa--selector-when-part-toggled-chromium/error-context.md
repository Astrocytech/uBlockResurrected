...
- Name: picker_tests/candidate-ui.spec.ts >> Picker Candidate UI >> Candidate Parts Toggle >> should update selector when part toggled
- Location: tests/picker_tests/candidate-ui.spec.ts:185:9
