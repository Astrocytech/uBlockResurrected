...
```
Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open '/home/glompy/Desktop/ASTROCYTECH/git_project/uBlockResurrected/test-results/.playwright-artifacts-1/traces/3e0ba35eddf9d2985ef2-84ef6b90729801f6970f-retry1.trace'
```
