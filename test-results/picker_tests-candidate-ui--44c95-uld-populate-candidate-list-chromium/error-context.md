...
- Name: picker_tests/candidate-ui.spec.ts >> Picker Candidate UI >> Dialog Display >> should populate candidate list
- Location: tests/picker_tests/candidate-ui.spec.ts:51:9
