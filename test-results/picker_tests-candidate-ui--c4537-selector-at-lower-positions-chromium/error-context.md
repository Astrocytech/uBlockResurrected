...
- Name: picker_tests/candidate-ui.spec.ts >> Picker Candidate UI >> Slider >> should select less specific selector at lower positions
- Location: tests/picker_tests/candidate-ui.spec.ts:156:9
