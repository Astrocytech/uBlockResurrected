(() => {
  ...
  (function() {
    ...
    const stripAdData = function(obj, depth) {
      ...
      for (var key in obj) {
        if (AD_KEYS.indexOf(key) !== -1 || key === "trackingParams" && typeof obj[key] === "string" && obj[key].indexOf("AB") === 0) {
    ...
    window.fetch = function(resource, options) {
      ...
      var isYouTubeApi = url && (url.indexOf("youtube.com/youtubei/v1/player") !== -1 || url.indexOf("youtube.com/apiManifest") !== -1);
      if (isYouTubeApi) {
    ...
    XMLHttpRequest.prototype.open = function(method, url, async, user, password) {
      this._ytApi = url && (url.indexOf("youtube.com/youtubei/v1/player") !== -1 || url.indexOf("youtube.com/apiManifest") !== -1);
      this._url = url;
    ...
    elementProto.appendChild = function(newChild) {
      if (newChild && newChild.nodeName === "SCRIPT") {
        ...
        if (src.indexOf("ytinitialplayerresponse") !== -1 || src.indexOf("player") !== -1) {
          console.log(
