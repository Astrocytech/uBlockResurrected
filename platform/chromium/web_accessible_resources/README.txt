...
Any fetch operation made without uBlock Resurrected's internal secret will result
...
Only uBlock Resurrected knows the secret token at runtime and hence only
uBlock Resurrected can access the content of this folder.
