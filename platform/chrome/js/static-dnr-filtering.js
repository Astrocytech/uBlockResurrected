...
`
  ...
  var FRAME_ANY = 32 /* MAIN_FRAME */ | 2048 /* SUB_FRAME */ | 128 /* OBJECT */;
  var FONT_ANY = 4 /* FONT */ | 16384 /* INLINE_FONT */;
  var INLINE_ANY = 16384 /* INLINE_FONT */ | 32768 /* INLINE_SCRIPT */;
  var PING_ANY = 1 /* BEACON */ | 2 /* CSP_REPORT */ | 256 /* PING */;
  var SCRIPT_ANY = 512 /* SCRIPT */ | 32768 /* INLINE_SCRIPT */;
  var typeStrToIntMap = {
    "no_type": 0 /* NO_TYPE */,
    "beacon": 1 /* BEACON */,
  ...
  var reIPv4 = /^\d+\.\d+\.\d+\.\d+$/;
  var FilteringContext = class _FilteringContext {
    tstamp = 0;
    realm = "";
    method = 0;
    itype = 0 /* NO_TYPE */;
  ...
  var isRegexOrPath = (hn2) => hn2.includes("/");
  var rePlainSelector = /^[#.][\w\\-]+/;
  var rePlainSelectorEx = /^[^#.[(]+([#.][\w-]+)|([#.][\w-]+)$/;
  var rePlainSelectorEscaped = /^[#.](?:\\[0-9A-Fa-f]+ |\\.|\w|-)+/;
  var reEscapeSequence = /\\([0-9A-Fa-f]+ |.)/g;
  var keyFromSelector = (selector) => {
    let key = "";
