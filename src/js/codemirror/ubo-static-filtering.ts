...
function initHints(): void {
    ...
    CodeMirror.registerHelper('hint', 'ubo-static-filtering', function(cm: CodeMirrorEditor) {
...

{
    ...
    CodeMirror.defineInitHook(cm => {
        ...
        cm.on('fold', function(cm: CodeMirrorEditor, from: CodeMirrorPos) {
            const doc = cm.getDoc();
        ...
        cm.on('unfold', function(cm: CodeMirrorEditor, from: CodeMirrorPos) {
            const doc = cm.getDoc();
            const lineHandle = doc.getLineHandle(from.line);
            const marker = extractMarker(lineHandle);
            if (marker === null) { return; }
...

{
    ...
    CodeMirror.defineInitHook(cm => {
        cm.setOption('configureMouse', function(_cm: CodeMirrorEditor, repeat: string | unknown) {
            return {
